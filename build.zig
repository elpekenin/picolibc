...
const PRINTF_LEVEL: PRINTF_LEVELS = .PRINTF_MIN;
...
pub fn build(b: *std.Build) !void {
    ...
    const use_tinystdio = b.option(bool, "tinystdio", "whether to use tinystdio or regular stdio") orelse true;
    ...
    const picolibc_h = b.addConfigHeader(.{
        ...
        ._NANO_MALLOC = {},
        ._NEWLIB_VERSION = b.fmt("{}.{}.{}", .{ newlib_ver.major, newlib_ver.minor, newlib_ver.patch }),
        ._PICO_EXIT = {},
        ._PICOLIBC_MINOR__ = @as(i64, @intCast(picolibc_ver.minor)),
        ._PICOLIBC_VERSION = b.fmt("{}.{}.{}", .{ picolibc_ver.major, picolibc_ver.minor, picolibc_ver.patch }),
        ._PICOLIBC__ = 1,
    ...
    newlib.addSystemIncludePath(.{ .path = "newlib/libc/include" });
    newlib.addSystemIncludePath(.{ .path = "newlib/libm/common" });

    if (use_tinystdio) {
        newlib.defineCMacro("_FORMAT_DEFAULT_MINIMAL", null);
        newlib.addSystemIncludePath(.{ .path = "newlib/libc/tinystdio" });
    } else {
        newlib.addSystemIncludePath(.{ .path = "newlib/libc/stdio" });
        newlib.addSystemIncludePath(.{ .path = "newlib/libc/stdio/sys" });
    }
    ...
    switch (newlib.rootModuleTarget().cpu.arch) {
        .avr => {
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/avr/setjmp.S" });
        },
        .arc => {
            newlib.addSystemIncludePath(.{ .path = "newlib/libc/machine/arc" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/memcmp-bs-norm.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/memcmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/memcpy-archs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/memcpy-bs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/memcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/memset-archs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/memset-bs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/memset.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/setjmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strchr-bs-norm.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strchr-bs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strcmp-archs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strcmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strcpy-bs-arc600.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strcpy-bs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strlen-bs-norm.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strlen-bs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strlen.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strncpy-bs.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arc/strncpy.S" });
        },
        .arm, .armeb => {
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/aeabi_memcpy-armv7a.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memset-arm.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memset.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/setjmp.S" });
            // TODO
            // switch (newlib.rootModuleTarget().cpu.model.toCpu(.arm)) {
            //     else => {},
            // }
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memcpy-armv7a.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memcpy-armv7m.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcmp-arm-tiny.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcmp-armv4.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcmp-armv4t.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcmp-armv6.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcmp-armv6m.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcmp-armv7.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcmp-armv7m.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strlen-armv7.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strlen.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/picolib/machine/arm/read_tp.S" });
        },
        .thumb, .thumbeb => {
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memcpy.S" });
            ...
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strlen.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/picolib/machine/arm/read_tp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memset-thumb.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strlen-thumb1-Os.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/memset-thumb2.S" });
            // newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/arm/strlen-thumb2-Os.S" });
        },
        .aarch64, .aarch64_be, .aarch64_32 => {
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/memchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/memcmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/memcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/memmove.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/memrchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/memset.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/rawmemchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/setjmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/stpcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/strchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/strchrnul.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/strcmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/strcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/strlen.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/strncmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/strnlen.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/aarch64/strrchr.S" });
        },
        .m68k => {
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/m68k/memcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/m68k/memset.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/m68k/setjmp.S" });
        },
        .mips, .mipsel => {
            newlib.addSystemIncludePath(.{ .path = "newlib/libc/machine/mips" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/mips/memcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/mips/memset.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/mips/setjmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/mips/strcmp.S" });
        },
        .riscv32, .riscv64 => {
            newlib.addSystemIncludePath(.{ .path = "newlib/libc/machine/riscv" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/riscv/memcpy-asm.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/riscv/memmove.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/riscv/memset.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/riscv/setjmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/riscv/strcmp.S" });
        },
        .sparc => {
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/sparc/setjmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/picolib/machine/sparc/interrupt.S" });
        },
        .spu_2 => {
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/fiprintf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/fiscanf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/fprintf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/fscanf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/iprintf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/iscanf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/printf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/scanf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/setjmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/siprintf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/siscanf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/sniprintf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/snprintf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/sprintf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/spu-mcount.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/spu_timer_flih.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/sscanf.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/spu/stack_reg_va.S" });
        },
        .x86, .x86_64 => {
            if (newlib.rootModuleTarget().cpu.arch == .x86_64) {
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memcpy-64.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memset-64.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/setjmp-64.S" });
                newlib.addAssemblyFile(.{ .path = "picocrt/machine/x86/crt0-64.S" });
            } else {
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memchr-32.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memcmp-32.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memcpy-32.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memmove-32.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memset-32.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/setjmp-32.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/strlen-32.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/strchr-32.S" });
                newlib.addAssemblyFile(.{ .path = "picocrt/machine/x86/crt0-32.S" });

                // libm
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_atan2.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_atan2f.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_frexp.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_frexpf.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_ldexp.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_ldexpf.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_log.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_log10.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_log10f.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_logf.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_tan.S" });
                newlib.addAssemblyFile(.{ .path = "newlib/libm/machine/x86/f_tanf.S" });
            }
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memcmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memmove.S" });

            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/memset.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/setjmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/strchr.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/x86/strlen.S" });
        },
        .xtensa => {
            newlib.addSystemIncludePath(.{ .path = "newlib/libc/machine/xtensa" });
            newlib.addSystemIncludePath(.{ .path = "newlib/libc/sys/xtensa/include/xtensa/config" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/xtensa/memcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/xtensa/memset.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/xtensa/setjmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/xtensa/strcmp.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/xtensa/strcpy.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/xtensa/strlen.S" });
            newlib.addAssemblyFile(.{ .path = "newlib/libc/machine/xtensa/strncpy.S" });
        },
        else => {},
    }
    ...
    newlib.installHeadersDirectory(
        b.path(
            if (use_tinystdio) "newlib/libc/tinystdio"
            else "newlib/libc/stdio"
        ),
        "",
        .{
            .exclude_extensions = &.{
...
const tinystdio_level = switch (PRINTF_LEVEL) {
    .PRINTF_MIN => &.{
    ...
    else => @panic("Level not supported."),
};

const tinystdio = &.{
    // These are always include'd, not compiled on their own
